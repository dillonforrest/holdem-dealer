...
holdem_dealer.core.NodeComponent.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4149__auto__,k6909,else__4150__auto__){var self__ = this;
var this__4149__auto____$1 = this;var G__6911 = (((k6909 instanceof cljs.core.Keyword))?k6909.fqn:null);switch (G__6911) {
case "web":
return self__.web;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k6909,else__4150__auto__);
...
holdem_dealer.core.NodeComponent.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4154__auto__,k__4155__auto__,G__6908){var self__ = this;
var this__4154__auto____$1 = this;var pred__6912 = cljs.core.keyword_identical_QMARK_;var expr__6913 = k__4155__auto__;if(cljs.core.truth_(pred__6912.call(null,new cljs.core.Keyword(null,"options","options",99638489),expr__6913)))
{return (new holdem_dealer.core.NodeComponent(G__6908,self__.config,self__.queue,self__.web,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__6912.call(null,new cljs.core.Keyword(null,"config","config",994861415),expr__6913)))
{return (new holdem_dealer.core.NodeComponent(self__.options,G__6908,self__.queue,self__.web,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__6912.call(null,new cljs.core.Keyword(null,"queue","queue",1455835879),expr__6913)))
{return (new holdem_dealer.core.NodeComponent(self__.options,self__.config,G__6908,self__.web,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__6912.call(null,new cljs.core.Keyword(null,"web","web",-654701153),expr__6913)))
{return (new holdem_dealer.core.NodeComponent(self__.options,self__.config,self__.queue,G__6908,self__.__meta,self__.__extmap,null));
} else
{return (new holdem_dealer.core.NodeComponent(self__.options,self__.config,self__.queue,self__.web,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4155__auto__,G__6908),null));
}
}
}
}
...
holdem_dealer.core.NodeComponent.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4146__auto__,G__6908){var self__ = this;
var this__4146__auto____$1 = this;return (new holdem_dealer.core.NodeComponent(self__.options,self__.config,self__.queue,self__.web,G__6908,self__.__extmap,self__.__hash));
});
...
holdem_dealer.core.map__GT_NodeComponent = (function map__GT_NodeComponent(G__6910){return (new holdem_dealer.core.NodeComponent(new cljs.core.Keyword(null,"options","options",99638489).cljs$core$IFn$_invoke$arity$1(G__6910),new cljs.core.Keyword(null,"config","config",994861415).cljs$core$IFn$_invoke$arity$1(G__6910),new cljs.core.Keyword(null,"queue","queue",1455835879).cljs$core$IFn$_invoke$arity$1(G__6910),new cljs.core.Keyword(null,"web","web",-654701153).cljs$core$IFn$_invoke$arity$1(G__6910),null,cljs.core.dissoc.call(null,G__6910,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"queue","queue",1455835879),new cljs.core.Keyword(null,"web","web",-654701153))));
});
...
holdem_dealer.core.NodeSystem.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4149__auto__,k6917,else__4150__auto__){var self__ = this;
var this__4149__auto____$1 = this;var G__6919 = (((k6917 instanceof cljs.core.Keyword))?k6917.fqn:null);switch (G__6919) {
case "web":
return self__.web;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k6917,else__4150__auto__);
...
holdem_dealer.core.NodeSystem.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4154__auto__,k__4155__auto__,G__6916){var self__ = this;
var this__4154__auto____$1 = this;var pred__6920 = cljs.core.keyword_identical_QMARK_;var expr__6921 = k__4155__auto__;if(cljs.core.truth_(pred__6920.call(null,new cljs.core.Keyword(null,"config-options","config-options",-448864674),expr__6921)))
{return (new holdem_dealer.core.NodeSystem(G__6916,self__.web,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__6920.call(null,new cljs.core.Keyword(null,"web","web",-654701153),expr__6921)))
{return (new holdem_dealer.core.NodeSystem(self__.config_options,G__6916,self__.__meta,self__.__extmap,null));
} else
{return (new holdem_dealer.core.NodeSystem(self__.config_options,self__.web,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4155__auto__,G__6916),null));
}
}
});
...
holdem_dealer.core.NodeSystem.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4146__auto__,G__6916){var self__ = this;
var this__4146__auto____$1 = this;return (new holdem_dealer.core.NodeSystem(self__.config_options,self__.web,G__6916,self__.__extmap,self__.__hash));
});
...
holdem_dealer.core.map__GT_NodeSystem = (function map__GT_NodeSystem(G__6918){return (new holdem_dealer.core.NodeSystem(new cljs.core.Keyword(null,"config-options","config-options",-448864674).cljs$core$IFn$_invoke$arity$1(G__6918),new cljs.core.Keyword(null,"web","web",-654701153).cljs$core$IFn$_invoke$arity$1(G__6918),null,cljs.core.dissoc.call(null,G__6918,new cljs.core.Keyword(null,"config-options","config-options",-448864674),new cljs.core.Keyword(null,"web","web",-654701153))));
});
...
var _main__delegate = function (args){var foo_6924 = (holdem_dealer.core.some_node_module["foo"]);var bar_6925 = (holdem_dealer.core.some_node_module["bar"]);foo_6924.call(null);
bar_6925.call(null);
...
_main.cljs$lang$applyTo = (function (arglist__6926){
