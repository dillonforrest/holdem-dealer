...
holdem_dealer.web.WebComponent.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4149__auto__,k6933,else__4150__auto__){var self__ = this;
var this__4149__auto____$1 = this;var G__6935 = (((k6933 instanceof cljs.core.Keyword))?k6933.fqn:null);switch (G__6935) {
case "queue":
return self__.queue;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k6933,else__4150__auto__);
...
holdem_dealer.web.WebComponent.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4154__auto__,k__4155__auto__,G__6932){var self__ = this;
var this__4154__auto____$1 = this;var pred__6936 = cljs.core.keyword_identical_QMARK_;var expr__6937 = k__4155__auto__;if(cljs.core.truth_(pred__6936.call(null,new cljs.core.Keyword(null,"config","config",994861415),expr__6937)))
{return (new holdem_dealer.web.WebComponent(G__6932,self__.fpga,self__.queue,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__6936.call(null,new cljs.core.Keyword(null,"fpga","fpga",2082873291),expr__6937)))
{return (new holdem_dealer.web.WebComponent(self__.config,G__6932,self__.queue,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__6936.call(null,new cljs.core.Keyword(null,"queue","queue",1455835879),expr__6937)))
{return (new holdem_dealer.web.WebComponent(self__.config,self__.fpga,G__6932,self__.__meta,self__.__extmap,null));
} else
{return (new holdem_dealer.web.WebComponent(self__.config,self__.fpga,self__.queue,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4155__auto__,G__6932),null));
}
}
}
});
...
holdem_dealer.web.WebComponent.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4146__auto__,G__6932){var self__ = this;
var this__4146__auto____$1 = this;return (new holdem_dealer.web.WebComponent(self__.config,self__.fpga,self__.queue,G__6932,self__.__extmap,self__.__hash));
});
...
var port = new cljs.core.Keyword(null,"port","port",1534937262).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"web","web",-654701153).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"-config","-config",1985268249).cljs$core$IFn$_invoke$arity$1(self__.config)));var app = holdem_dealer.web.express.call(null);var G__6939_6941 = app;G__6939_6941.get("/",((function (G__6939_6941,port,app,this$__$1){
return (function (req,res){return res.send("Hello World");
});})(G__6939_6941,port,app,this$__$1))
);
G__6939_6941.listen(port);
...
holdem_dealer.web.map__GT_WebComponent = (function map__GT_WebComponent(G__6934){return (new holdem_dealer.web.WebComponent(new cljs.core.Keyword(null,"config","config",994861415).cljs$core$IFn$_invoke$arity$1(G__6934),new cljs.core.Keyword(null,"fpga","fpga",2082873291).cljs$core$IFn$_invoke$arity$1(G__6934),new cljs.core.Keyword(null,"queue","queue",1455835879).cljs$core$IFn$_invoke$arity$1(G__6934),null,cljs.core.dissoc.call(null,G__6934,new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"fpga","fpga",2082873291),new cljs.core.Keyword(null,"queue","queue",1455835879))));
});
