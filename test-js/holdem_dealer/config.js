...
holdem_dealer.config.ConfigComponent.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4149__auto__,k6893,else__4150__auto__){var self__ = this;
var this__4149__auto____$1 = this;var G__6895 = (((k6893 instanceof cljs.core.Keyword))?k6893.fqn:null);switch (G__6895) {
case "-config":
return self__._config;

break;
default:
return cljs.core.get.call(null,self__.__extmap,k6893,else__4150__auto__);
...
holdem_dealer.config.ConfigComponent.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4154__auto__,k__4155__auto__,G__6892){var self__ = this;
var this__4154__auto____$1 = this;var pred__6896 = cljs.core.keyword_identical_QMARK_;var expr__6897 = k__4155__auto__;if(cljs.core.truth_(pred__6896.call(null,new cljs.core.Keyword(null,"-config","-config",1985268249),expr__6897)))
{return (new holdem_dealer.config.ConfigComponent(G__6892,self__.__meta,self__.__extmap,null));
} else
{return (new holdem_dealer.config.ConfigComponent(self__._config,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4155__auto__,G__6892),null));
}
});
...
holdem_dealer.config.ConfigComponent.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4146__auto__,G__6892){var self__ = this;
var this__4146__auto____$1 = this;return (new holdem_dealer.config.ConfigComponent(self__._config,G__6892,self__.__extmap,self__.__hash));
});
...
holdem_dealer.config.map__GT_ConfigComponent = (function map__GT_ConfigComponent(G__6894){return (new holdem_dealer.config.ConfigComponent(new cljs.core.Keyword(null,"-config","-config",1985268249).cljs$core$IFn$_invoke$arity$1(G__6894),null,cljs.core.dissoc.call(null,G__6894,new cljs.core.Keyword(null,"-config","-config",1985268249))));
});
